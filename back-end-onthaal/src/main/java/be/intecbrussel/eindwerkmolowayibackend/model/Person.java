...
public abstract class Person implements IPerson, Serializable {
	...
	private static final long serialVersionUID = 4613013198095230193L;
	@Id
	...
	public Person(String firstName, String lastName, String origin, Timestamp birthDate, StatusOfThePerson status,
			Contact contact, List<Message> sent_messages, List<Message> received_messages) {
	...
	public String toString() {
		return "Person{" + "firstName='" + firstName + '\'' + ", lastName='" + lastName + '\'' + ", origin='" + origin
	...
	public boolean equals(Object o) {
		...
		if (!getLastName().equals(person.getLastName()))
			return false;
		if (!getOrigin().equals(person.getOrigin()))
			return false;
		if (!getBirthDate().equals(person.getBirthDate()))
			return false;
